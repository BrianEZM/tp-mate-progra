...
from services.binario.binario_converter import es_binario,binario_decimal,binario_octal,binario_Hexa
...
while programa_on:
    ...
    # Se valida que sea un numero binario valido, si lo es, se convierte a los de mas sistemas
        while True:
            if es_binario(entrada_binaria):
                decimal = binario_decimal(entrada_binaria)
                hexadecimal = binario_Hexa(binario_decimal(entrada_binaria))
                octal = binario_octal(binario_decimal(entrada_binaria))
            ...
            # Si no es un numero binario valido, se muestran mensajes explicativos
                ...
                print("Un número binario solo puede contener dígitos del 0 o 1.")
                print("-" * 30)
                entrada_hexa = input(
